...
| Regex + whole-word search modes | `specs/2026-07-11-fleet-search-enhancements-design.md:63-68` | Fuzzy file matching shipped in 4o; regex/whole-word content modes remain. |
