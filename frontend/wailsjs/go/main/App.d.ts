...
export function GetBrief():Promise<intel.Brief>;

export function GetChat(arg1:string):Promise<Array<intel.Turn>>;
...
export function SaveBrief(arg1:string,arg2:string,arg3:string):Promise<string>;

export function SaveChat(arg1:string,arg2:Array<intel.Turn>):Promise<string>;

export function SaveConfig(arg1:config.Config):Promise<string>;

export function ScanRepos():Promise<Array<main.RepoView>>;

export function SearchAll(arg1:string,arg2:boolean,arg3:boolean,arg4:boolean):Promise<Array<main.SearchHit>>;
